    ...
    <section id="events" className="sec-pad mx-auto max-w-[1240px] scroll-mt-[76px]">
      ...
      <div className="flex flex-col">
        {events.map((ev) => (
          ...
          >
            <div className="font-latin text-[22px] font-semibold tracking-[1px] text-gold">{ev.date}</div>
            <div>
            ...
            <div className="hidden font-latin text-[13px] tracking-[2px] text-rice-dim md:block">{ev.card}</div>
            {ev.status === "hot" ? (
